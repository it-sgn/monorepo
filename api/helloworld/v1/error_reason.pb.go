...
const file_api_helloworld_v1_error_reason_proto_rawDesc = "" +
	"\n" +
	"$api/helloworld/v1/error_reason.proto\x12\rhelloworld.v1*9\n" +
	"\vErrorReason\x12\x16\n" +
	"\x12GEETER_UNSPECIFIED\x10\x00\x12\x12\n" +
	"\x0eUSER_NOT_FOUND\x10\x01BE\n" +
	"\rhelloworld.v1P\x01Z kratos-cron/api/helloworld/v1;v1\xa2\x02\x0fAPIHelloworldV1b\x06proto3"
