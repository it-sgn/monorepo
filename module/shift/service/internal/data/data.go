...
import (
	...
	"mall-go/module/shift/service/internal/data/model"
	"mall-go/module/shift/service/internal/data/model/migrate"
...
var ProviderSet = wire.NewSet(NewData, NewEntClient, NewRedisClient, NewShiftRepo)
