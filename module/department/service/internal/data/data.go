...
import (
	...
	"mall-go/module/department/service/internal/data/model"
	"mall-go/module/department/service/internal/data/model/migrate"
...
var ProviderSet = wire.NewSet(NewData, NewEntClient, NewDepartmentRepo)
