...
// The ShiftScheduleFunc type is an adapter to allow the use of ordinary
// function as ShiftSchedule mutator.
type ShiftScheduleFunc func(context.Context, *model.ShiftScheduleMutation) (model.Value, error)

// Mutate calls f(ctx, m).
func (f ShiftScheduleFunc) Mutate(ctx context.Context, m model.Mutation) (model.Value, error) {
	if mv, ok := m.(*model.ShiftScheduleMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *model.ShiftScheduleMutation", m)
}
