...
const file_module_department_service_internal_conf_conf_proto_rawDesc = "" +
	"\n" +
	"2module/department/service/internal/conf/conf.proto\x12 department.service.internal.conf\x1a\x1egoogle/protobuf/duration.proto\"\xc8\x01\n" +
	"\tBootstrap\x12@\n" +
	"\x06server\x18\x01 \x01(\v2(.department.service.internal.conf.ServerR\x06server\x12:\n" +
	"\x04data\x18\x02 \x01(\v2&.department.service.internal.conf.DataR\x04data\x12=\n" +
	"\x05trace\x18\x03 \x01(\v2'.department.service.internal.conf.TraceR\x05trace\"#\n" +
	"\x05Trace\x12\x1a\n" +
	"\bendpoint\x18\x01 \x01(\tR\bendpoint\"\xe4\x02\n" +
	"\x06Server\x12A\n" +
	"\x04http\x18\x01 \x01(\v2-.department.service.internal.conf.Server.HTTPR\x04http\x12A\n" +
	"\x04grpc\x18\x02 \x01(\v2-.department.service.internal.conf.Server.GRPCR\x04grpc\x1ai\n" +
	"\x04HTTP\x12\x18\n" +
	...
	"\anetwork\x18\x01 \x01(\tR\anetwork\x12\x12\n" +
	"\x04addr\x18\x02 \x01(\tR\x04addr\x123\n" +
	"\atimeout\x18\x03 \x01(\v2\x19.google.protobuf.DurationR\atimeout\"\xf0\x05\n" +
	"\x04Data\x12K\n" +
	"\bdatabase\x18\x01 \x01(\v2/.department.service.internal.conf.Data.DatabaseR\bdatabase\x12B\n" +
	"\x05redis\x18\x02 \x01(\v2,.department.service.internal.conf.Data.RedisR\x05redis\x12B\n" +
	"\x05kafka\x18\x03 \x01(\v2,.department.service.internal.conf.Data.KafkaR\x05kafka\x1a:\n" +
	"\bDatabase\x12\x16\n" +
	...
	"\rwrite_timeout\x18\a \x01(\v2\x19.google.protobuf.DurationR\fwriteTimeout\"\x91\x01\n" +
	"\bRegistry\x12I\n" +
	"\x06consul\x18\x01 \x01(\v21.department.service.internal.conf.Registry.ConsulR\x06consul\x1a:\n" +
	"\x06Consul\x12\x18\n" +
	"\aaddress\x18\x01 \x01(\tR\aaddress\x12\x16\n" +
	"\x06scheme\x18\x02 \x01(\tR\x06schemeB6Z4mall-go/module/department/service/internal/conf;confb\x06proto3"
...
var file_module_department_service_internal_conf_conf_proto_goTypes = []any{
	(*Bootstrap)(nil),           // 0: department.service.internal.conf.Bootstrap
	(*Trace)(nil),               // 1: department.service.internal.conf.Trace
	(*Server)(nil),              // 2: department.service.internal.conf.Server
	(*Data)(nil),                // 3: department.service.internal.conf.Data
	(*Registry)(nil),            // 4: department.service.internal.conf.Registry
	(*Server_HTTP)(nil),         // 5: department.service.internal.conf.Server.HTTP
	(*Server_GRPC)(nil),         // 6: department.service.internal.conf.Server.GRPC
	(*Data_Database)(nil),       // 7: department.service.internal.conf.Data.Database
	(*Data_Redis)(nil),          // 8: department.service.internal.conf.Data.Redis
	(*Data_Kafka)(nil),          // 9: department.service.internal.conf.Data.Kafka
	(*Registry_Consul)(nil),     // 10: department.service.internal.conf.Registry.Consul
	(*durationpb.Duration)(nil), // 11: google.protobuf.Duration
}
var file_module_department_service_internal_conf_conf_proto_depIdxs = []int32{
	2,  // 0: department.service.internal.conf.Bootstrap.server:type_name -> department.service.internal.conf.Server
	3,  // 1: department.service.internal.conf.Bootstrap.data:type_name -> department.service.internal.conf.Data
	1,  // 2: department.service.internal.conf.Bootstrap.trace:type_name -> department.service.internal.conf.Trace
	5,  // 3: department.service.internal.conf.Server.http:type_name -> department.service.internal.conf.Server.HTTP
	6,  // 4: department.service.internal.conf.Server.grpc:type_name -> department.service.internal.conf.Server.GRPC
	7,  // 5: department.service.internal.conf.Data.database:type_name -> department.service.internal.conf.Data.Database
	8,  // 6: department.service.internal.conf.Data.redis:type_name -> department.service.internal.conf.Data.Redis
	9,  // 7: department.service.internal.conf.Data.kafka:type_name -> department.service.internal.conf.Data.Kafka
	10, // 8: department.service.internal.conf.Registry.consul:type_name -> department.service.internal.conf.Registry.Consul
	11, // 9: department.service.internal.conf.Server.HTTP.timeout:type_name -> google.protobuf.Duration
	11, // 10: department.service.internal.conf.Server.GRPC.timeout:type_name -> google.protobuf.Duration
	11, // 11: department.service.internal.conf.Data.Redis.read_timeout:type_name -> google.protobuf.Duration
	11, // 12: department.service.internal.conf.Data.Redis.write_timeout:type_name -> google.protobuf.Duration
	11, // 13: department.service.internal.conf.Data.Kafka.read_timeout:type_name -> google.protobuf.Duration
	11, // 14: department.service.internal.conf.Data.Kafka.write_timeout:type_name -> google.protobuf.Duration
