...
func NewNotificationRepo(data *Data, bio biometricV1.BiometricClient, dept departmentV1.DepartmentClient, logger log.Logger, rdb *redis.Client) biz.NotificationRepo {
...
// func (r *notificationRepo) CreateNotification(ctx context.Context, b *biz.Notification) (*biz.Notification, error) {
// 	po, err := r.data.db.Notification.
// 		Create().
// 		SetNosap(b.NoSap).
// 		SetNip(b.Nip).
...
// 		return nil, err
// 	}
// 	r.redisClient.Del(ctx, "notification:list")
// 	r.redisClient.Del(ctx, "notification:"+string(po.ID)) //  Invalidate specific employer cache if exists
...
// func (r *notificationRepo) UpdateNotification(ctx context.Context, b *biz.Notification) (*biz.Notification, error) {
// 	po, err := r.data.db.Notification.
// 		UpdateOneID(b.Id).
// 		SetNosap(b.NoSap).
// 		SetNip(b.Nip).
...
// 	r.redisClient.Del(ctx, "notification:list")
// 	r.redisClient.Del(ctx, "notification:"+string(po.ID)) // Invalidate specific employer cache
...
// 	}, nil
// }
// func (r *notificationRepo) GetNotificationID(ctx context.Context, id int64) (*biz.Notification, error) {
// 	cacheKey := "employer:" + string(id)
// 	val, err := r.redisClient.Get(ctx, cacheKey).Result()
// 	if err == nil {
// 		var cachedEmployer biz.Notification
...
// 	po, err := r.data.db.Notification.Get(ctx, id)
// 	if err != nil {
// 		return nil, err
// 	}

// 	employer := &biz.Notification{
// 		Id:         po.ID,
// 		NoSap:      *po.Nosap,
// 		Nip:        *po.Nip,
// 		KaryaCode:  *po.Karyacode,
...
// // func (r *notificationRepo) ListNotification(ctx context.Context, pageNum, pageSize int64) ([]*biz.EmployerData, int, error) {
...
// // 	pos, err := r.data.db.Notification.Query().
...
// // 	if r.Log != nil {
// // 		r.Log.Warnf("ListNotification result: %+v", pos)
// // 	}
...
// //	}
// func (r *notificationRepo) ListNotification(ctx context.Context, pageNum, pageSize int64) ([]*biz.EmployerData, int, error) {
// 	cacheKey := "notification:list:page:" + string(pageNum) + ":size:" + string(pageSize)
// 	val, err := r.redisClient.Get(ctx, cacheKey).Result()
// 	if err == nil {
// 		var cachedResponse struct {
// 			Notification []*biz.EmployerData
// 			Total        int
// 		}
// 		var cachedEmployer biz.Notification
// 		unmarshalErr := json.Unmarshal([]byte(val), &cachedEmployer)
// 		if unmarshalErr := json.Unmarshal([]byte(val), &cachedResponse); unmarshalErr == nil {
// 			r.Log.Infof("Cache hit for ListNotification page %d, size %d", pageNum, pageSize)
// 			return cachedResponse.Notification, cachedResponse.Total, nil
// 		}

// 		r.Log.Warnf("Failed to unmarshal cached ListNotification: %v", unmarshalErr)
// 	} else if err != redis.Nil {
// 		r.Log.Errorf("Redis GET error for ListNotification: %v", err)
// 	}
...
// 	if r.Log != nil {
// 		r.Log.Warnf("ListNotification result from DB: %+v", pos)
// 	}
// 	rv := make([]*biz.EmployerData, 0, len(pos))
// 	for _, po := range pos {
// 		empData := &biz.EmployerData{
...
// 	} else {
// 		r.Log.Errorf("Failed to marshal ListNotification response for caching: %v", marshalErr)
// 	}

// 	return rv, total, nil
// }
// func (r *notificationRepo) Count(ctx context.Context) (int, error) {
// 	dt, _ := r.data.db.Notification.Query().Count(ctx)
// 	// fmt.Println("INI PL DT: ")
// 	return dt, nil
// }
// func (r *notificationRepo) ListNotificationNext(ctx context.Context, start, end int32) ([]*biz.Notification, error) {
...
// 		return nil, err
// 	}
// 	rv := make([]*biz.Notification, 0, len(pos))
// 	for _, po := range pos {
// 		rv = append(rv, &biz.Notification{
// 			Id:         po.ID,
// 			NoSap:      *po.Nosap,
// 			Nip:        *po.Nip,
// 			KaryaCode:  *po.Karyacode,
...
// func (r *notificationRepo) DeleteNotification(ctx context.Context, id int64) error {
// 	err := r.data.db.Notification.
// 		DeleteOneID(id).
// 		Exec(ctx)
...
// func (r *notificationRepo) GetEmployerDetail(ctx context.Context, id int64) (*biz.EmployerData, error) {
...
// 	emp, err := r.data.db.Notification.Get(ctx, id)
// 	if err != nil {
// 		return nil, err
// 	}
