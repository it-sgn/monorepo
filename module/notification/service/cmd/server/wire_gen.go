...
func wireApp(confServer *conf.Server, confData *conf.Data, registry *conf.Registry, logger log.Logger) (*kratos.App, func(), error) {
	...
	notificationRepo := data.NewNotificationRepo(dataData, biometricClient, departmentClient, logger, redisClient)
	notificationUsecase := biz.NewNotificationUsecase(notificationRepo, logger, departmentClient, biometricClient)
	notificationService := service.NewNotificationService(notificationUsecase, logger)
