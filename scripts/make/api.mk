...
Employers_API_PROTO_FILES=$(shell find api/employers -name *.proto)
Biometric_API_PROTO_FILES=$(shell find api/biometric -name *.proto)
Department_API_PROTO_FILES=$(shell find api/department -name *.proto)
.PHONY: api.app
api.app:
...
.PHONY: api.employers
api.employers:
		protoc --proto_path=./api/employers/service \
    	       --proto_path=./third_party \
     	       --go_out=paths=source_relative:./module/employers/service/internal/service \
     	       --go-http_out=paths=source_relative:./module/employers/service/internal/service \
			   --grpc-gateway_out=paths=source_relative:./api \
     	       --go-grpc_out=paths=source_relative:./module/employers/service/internal/service \
    	       --openapi_out=fq_schema_naming=true,default_response=false:. \
    	       $(Employers_API_PROTO_FILES)		

.PHONY: api.biometric
api.biometric:
		protoc --proto_path=./api/biometric/service \
    	       --proto_path=./third_party \
     	       --go_out=paths=source_relative:./module/biometric/service/internal/service \
     	       --go-http_out=paths=source_relative:./module/biometric/service/internal/service \
			   --grpc-gateway_out=paths=source_relative:./api \
     	       --go-grpc_out=paths=source_relative:./module/biometric/service/internal/service \
    	       --openapi_out=fq_schema_naming=true,default_response=false:. \
    	       $(Biometric_API_PROTO_FILES)		

.PHONY: api.department				   
api.department:
		protoc --proto_path=./api/department/service \
    	       --proto_path=./third_party \
     	       --go_out=paths=source_relative:./module/department/service/internal/service \
     	       --go-http_out=paths=source_relative:./module/department/service/internal/service \
			   --grpc-gateway_out=paths=source_relative:./api \
     	       --go-grpc_out=paths=source_relative:./module/department/service/internal/service \
    	       --openapi_out=fq_schema_naming=true,default_response=false:. \
    	       $(Department_API_PROTO_FILES)						   